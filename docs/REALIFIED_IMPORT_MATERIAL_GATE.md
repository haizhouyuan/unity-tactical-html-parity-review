...
This gate checks technical import readiness only. Semantic category promotion and gameplay promotion remain separate fail-closed gates.

## Classes

| Category | Asset | LODs | PBR Sidecars | Imported LOD0 | Accepted Shader | Technical Ready |
|---|---|---:|---:|---:|---:|---:|
| weapon | hero_rifle | True | True | True | True | True |
...
| loot | medkit | True | True | True | True | True |
| environment_prop | container | True | True | True | True | True |
| environment_prop | crate | True | True | True | True | True |
